const educationData = [
  ...
  },
  {
    ...
    status: 'completed',
    color: 'blue',
    description: '研究聚焦於資料分析、啟發式演算法、電腦視覺（物件偵測、動作識別）、以及先進製程控制（APC）。於半導體智慧製造 APC 論文報告競賽中獲得第一名。',
    highlights: ['電腦視覺', '先進製程控制 (APC)', '數據分析', '參數最佳化', '啟發式演算法', '統計方法', '實驗設計', '生產計畫與管制'],
  },
  {
    id: 3,
    period: '2015 — 2019',
    ...
    highlights: ['化學反應工程', '程序控制', '化工裝置', '單元操作', '高分子化學'],
  },
]
